...
namespace Neuron.NetX.Sample.Adapters
{
    ...
    public partial class NameAdapter : ESBAdapterBase
    {
        ...
        public static class AdapterModeStringConstants
        {
            ...
            public const string SolicitResponse = "SolicitResponse";
       ...
       public async override Task SendToEndpoint(ESBMessage message, CommittableTransaction tx, CancellationToken cancellationToken)        
       {
        ...
        /// </summary>
        /// <returns></returns>
        private Neuron.NetX.ErrorLevel GetErrorLevelFromMode()
        {
            Neuron.NetX.ErrorLevel errorLevel = ErrorLevel.Error;
